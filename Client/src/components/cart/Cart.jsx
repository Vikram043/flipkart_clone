...
const Cart = () => {
    ...
    const handleOprnrazorPay = (data) => {
        ...
        const options = {
            ...
            handler: function (response) {
                ...
                axios.post('https://flipkart-clone-ry1e.onrender.com/api/verify', { response: response })
                    .then(res => {
                        console.log(res, "Payment Verified");
                        navigate('/');
                        setTimeout(() => {
    ...
    const buyNow = async (amount) => {
        ...
        axios.post(`https://flipkart-clone-ry1e.onrender.com/api/orders`, _data)
            .then(res => {
